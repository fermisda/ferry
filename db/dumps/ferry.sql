...
--
-- Data for Name: collaboration_unit_group; Type: TABLE DATA; Schema: public; Owner: ferry
--

COPY collaboration_unit_group (unitid, groupid, is_primary, last_updated) FROM stdin;
\.
...
COPY compute_resource (id, name, default_shell, comp_type, unitid, last_updated, default_home_dir) FROM stdin;
\.
...
--
-- Data for Name: grid_access; Type: TABLE DATA; Schema: public; Owner: ferry
--

COPY grid_access (uid, unitid, fqanid, is_superuser, is_banned, last_updated) FROM stdin;
\.
...
COPY user_certificate (uid, dn, issuer_ca, last_update, unitid) FROM stdin;
\.
